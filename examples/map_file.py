...
print "ITEM SYMBOLS"
for (i in range(len(item_id2sym))):
    print i," ",item_id2sym[i]

print "CODER SYMBOLS"
for (i in range(len(coder_id2sym))):
    print i," ",coder_id2sym[i]

print "LABEL SYMBOLS"
for (i in range(len(label_id2sym))):
    print i," ",label_id2sym[i]
